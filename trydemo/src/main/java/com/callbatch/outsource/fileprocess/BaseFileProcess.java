package com.callbatch.outsource.fileprocess;
...
import com.callbatch.outsource.fileprocess.impl.ProcessCsv;
import com.callbatch.outsource.fileprocess.impl.ProcessExcel;
import com.callbatch.outsource.source.IDataSource;
import com.callbatch.outsource.task.FutureData;
import com.callbatch.outsource.task.ReadTask;
import com.callbatch.outsource.task.WriteTask;
...
public abstract class BaseFileProcess {
	 ...
	 * 存放标签
	 */
	protected List<String> tagHead = new LinkedList<>();
